...
\title{Specialized drone object identification with master control and confidence assessment}


% Single author syntax
\author{
    Diogo A. Rosário, João Raposo, Ketevan
    \affiliations
...
\begin{abstract}
    The integration of agents into the realm of object identification and specialization stands as a captivating avenue of exploration with vast practical implications. 
    Our paramount objective in this study is twofold: to scrutinize the specialization of drones and to delve into the crucial role played by the master in governing these aerial agents. Our focus extends beyond the mere specialization of drones; we are keenly interested in comprehending how the concentration of training on specific object categories impacts the drones' proficiency in accurate object identification. Furthermore, our inquiry is directed towards unraveling the master's influence in harnessing confidence metrics to discern the optimal drones for particular identification tasks. The essence of our research lies in grasping the intricate interplay between drone specialization, master control, and the pragmatic application of confidence metrics in real-world scenarios.
\end{abstract}

\section{Introduction}

The integration of drones (Agents) in the field of object identification and specialization is a compelling area of research with diverse practical applications. In this proposal, we outline our approach to investigating this problem, addressing its importance, and highlighting the interesting facets of our research.
...
\subsubsection{Drone A}

\subsubsection{Drone B}

\subsubsection{Drone C}

\section{Training}

\section{CNN's Structure}
